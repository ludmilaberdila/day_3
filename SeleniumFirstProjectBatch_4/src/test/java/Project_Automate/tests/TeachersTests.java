package Project_Automate.tests;

import Project_Automate.StudyMateConfig;
import Project_Automate.TeachersWebElements;
import Project_Automate.Util;
...
public class TeachersTests {
    ...
    public void step17_enterLargeTeacherInput() throws InterruptedException {
        ...
        teacherToAdd.put("studyFormat", "API from Mr Jackson;Soft Skills Class");
    ...
    public void step18_enterEmptyAndNegativePhoneTeacher() throws InterruptedException {
        ...
        teacherToAdd.put("studyFormat", "Soft Skills Class");
